...
@Entity
public class HistoriaCantSiniestros {
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Id
    @Column(name = "idHistoriaCantSiniestros")
    private int idHistoriaCantSiniestros;
    @Basic
    ...
    public int getIdHistoriaCantSiniestros() {
        return idHistoriaCantSiniestros;
    }

    public void setIdHistoriaCantSiniestros(int idHistoriaCantSiniestros) {
        this.idHistoriaCantSiniestros = idHistoriaCantSiniestros;
    }
